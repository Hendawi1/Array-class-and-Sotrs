	...
	public:
		...
		bool operator==(const Array& other) {
			...
			*/
			...
			// عيب في هذه الطريقة هو لو وجدنا ان اكبر رقم في المصفوفة الاولى كبير جدا؟ في هذه الحالة سوف نقوم بانشاء المصفوفة المساعدة بحجم يساوي قيمة هذا الرقم = اهدار الذاكرة

			// هناك طريقة اخرى وهي ان نقوم بانشاء مصفوفة مساعدة من نوع بوول وطولها مساو لطول المصفوفات الداخلة في المقارنه ومن ثم نقوم بالاتي: نمر على عناصر المصفوفة الاولى ولكل عنصر نقوم بالبحث عنه في عناصر المصفوفة الثانية واذا وجدناه في اندكس ما في المصفوفة الصانية نقوم بوضع 1 في نفس الاندكس في المصفوفة المساعدة، وهكذا مع باقي العناصر، وفي حالة لم نجد العنصر نرجع القيمة فولس، واثناء البحث اذا وجدنا القيمة وكان في الاندكس الخاص بها في المصفوفة المساعدة مكتوب 1 فاننا نتجاوز هذه القيمة ونستمر في البحث لان هذا الرقم في هذا الاندكس قد تم حجزه بالفعل لقيمة سابقة من المصفوفة الاولى 
		}
